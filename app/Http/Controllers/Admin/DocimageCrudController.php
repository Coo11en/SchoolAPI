...
use App\Http\Requests\DocimageRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class DocimageCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class DocimageCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Docimage::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/docimage');
    ...
    {
        CRUD::setValidation(DocimageRequest::class);

        CRUD::field('documentName')->label('Наименование документа');
        //CRUD::field('documentSource')->label('Путь до изображения');
