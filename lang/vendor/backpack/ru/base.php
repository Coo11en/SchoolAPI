...
return [
    ...
    */
    ...
    'throttled' 		=> 'Недавно вы уже запрашивали сброс пароля. Пожалуйста, проверьте свою электронную почту. Если вы не получили наше письмо, пожалуйста, повторите попытку позже.',
