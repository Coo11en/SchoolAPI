...
{{--                        </div>--}}
                        <div class="btn-group">
                            <a href="{{ route('admin.news.edit', ['news' => $newsItem->id]) }}" type="button" class="btn btn-sm btn-outline-secondary">Редактировать</a>
                        </div>
                        <small class="text-muted">{{$newsItem->author}} ({{$newsItem->updated_at}})</small>
