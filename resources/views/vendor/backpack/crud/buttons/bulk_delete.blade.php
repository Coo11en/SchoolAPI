@if ($crud->hasAccess('bulkDelete') && $crud->get('list.bulkActions'))
	<a href="javascript:void(0)" title="Удалить выделенное" onclick="bulkDeleteEntries(this)" class="btn btn-sm btn-secondary bulk-button"><i class="la la-trash"></i> {{ trans('backpack::crud.delete') }}</a>
@endif
